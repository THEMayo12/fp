...
R1, U1 = np.loadtxt("../messwerte/R_1000.txt", unpack=True)
...
U1 = (1./(1.+2.*const.pi*R1*nu_mittel*C_eigen)*U1)/v1-U_a_eigen[4]
...
R2, U2 = np.loadtxt("../messwerte/R_100k.txt", unpack=True)
