...
# LateX-Tabelle erzeugen
t = lt.latextable(
    [f_metall, U_a_metall,delta_U, V_N_metall, delta_f_metall, np.log(f_metall), 10.**18.*W(U_a_norm_metall, delta_f_metall, R),np.log(W(U_a_norm_metall, delta_f_metall, R))],
