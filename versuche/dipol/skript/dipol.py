...
Te1=np.concatenate((T1[:30],T1[45:55],[T1[len(T1)-1]]))
Je1=np.concatenate((J1[:30],J1[45:55],[J1[len(J1)-1]]))
vale1,cove1=optimize.curve_fit(G,Te1,np.log(Je1))
#
Te2=np.concatenate((T2[:20],T2[36:45],[T2[len(T2)-1]]))
Je2=np.concatenate((J2[:20],J2[36:45],[J2[len(J2)-1]]))
